...
public class ${table.beanName}ClientImpl implements ${table.beanName}Client {
    ...
    @Override
    public Integer updateById(${table.beanName}Vo ${table.lowerBeanName}Vo) throws BaseException{
        ${table.beanName}Dto ${table.lowerBeanName}Dto = new ${table.beanName}Dto();
        BeanUtils.copyProperties(${table.lowerBeanName}Vo, ${table.lowerBeanName}Dto);
    ...
    @Override
    public Integer deleteById(Long id, String operatorId) throws BaseException{
        return ${table.lowerBeanName}Facade.deleteById(id, operatorId);
    }

    @Override
    public PageData<${table.beanName}Dto> listByPage(${table.beanName}ReqVo ${table.lowerBeanName}ReqVo) throws BaseException{
