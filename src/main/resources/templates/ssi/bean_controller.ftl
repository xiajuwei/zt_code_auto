...
public class ${table.beanName}Facade{
    ...
    @PostMapping("/add")
    @ApiOperation("")
    public ResultData<Integer> add(@ApiParam(value = "", required = true) @RequestBody ${table.beanName}Vo ${table.lowerBeanName}Vo) {
    ...
    @ApiOperation("")
    public ResultData<Integer> updateById(@ApiParam(value = "", required = true) @RequestBody ${table.beanName}Vo ${table.lowerBeanName}Vo) {
    ${table.lowerBeanName}Vo.setOperatorId(ShiroUtils.getUserId());
    ...
    @ApiOperation("")
    public ResultData<Integer> deleteById(@ApiParam(value = "", required = true) @RequestParam("id") Long id) {
        return new ResultData<>(${table.lowerBeanName}Client.deleteById(id, ShiroUtils.getUserId()));
    }

    @PostMapping("/listByPage")
    @ApiOperation("分页查询")
    public ResultData<PageData<${table.beanName}Dto>> listByPage(@RequestBody ${table.beanName}ReqVo ${table.lowerBeanName}ReqVo) {
